...
export const FeatureDisplay = ({
  ...
  return (
    <div className="grid h-full w-full grid-cols-1 overflow-hidden rounded-xl border-2 border-zinc-900 bg-white md:h-96 md:grid-cols-13">
      <div className="col-span-1 flex flex-col justify-between p-8 md:col-span-1 md:p-12">
        <div>
